...
import net.mcreator.youtubersnaturaldisasters.procedures.TechnosGasPersonOnEntityTickUpdateProcedure;
import net.mcreator.youtubersnaturaldisasters.init.YoutubersNaturalDisastersModEntities;

public class TechnosGasPersonEntity extends Monster {
	public TechnosGasPersonEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(YoutubersNaturalDisastersModEntities.TECHNOS_GAS_PERSON.get(), world);
	}

	public TechnosGasPersonEntity(EntityType<TechnosGasPersonEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0f);
		xpReward = 0;
		setNoAi(false);
	...
	public void baseTick() {
		super.baseTick();
		TechnosGasPersonOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
