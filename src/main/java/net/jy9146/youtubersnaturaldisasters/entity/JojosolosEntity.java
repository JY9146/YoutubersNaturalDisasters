...
public class JojosolosEntity extends Monster {
	public JojosolosEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(YoutubersNaturalDisastersModEntities.JOJOSOLOS.get(), world);
	}

	public JojosolosEntity(EntityType<JojosolosEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
