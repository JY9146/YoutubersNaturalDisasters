...
public class ReyablipblopEntity extends Monster {
	public ReyablipblopEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(YoutubersNaturalDisastersModEntities.REYABLIPBLOP.get(), world);
	}

	public ReyablipblopEntity(EntityType<ReyablipblopEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
