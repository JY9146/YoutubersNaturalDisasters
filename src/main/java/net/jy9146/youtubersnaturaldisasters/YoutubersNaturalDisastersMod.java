...
@Mod("youtubers_natural_disasters")
public class YoutubersNaturalDisastersMod {
	public static final Logger LOGGER = LogManager.getLogger(YoutubersNaturalDisastersMod.class);
	public static final String MODID = "youtubers_natural_disasters";

	public YoutubersNaturalDisastersMod() {
