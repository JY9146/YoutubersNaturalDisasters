...
public class DisasterSinkholeV2SummonerProcedure {
	public static void execute(LevelAccessor world, CommandContext<CommandSourceStack> arguments) {
		if (world instanceof ServerLevel _level)
			...
			}.getEntity()).getZ())), Vec2.ZERO, _level, 4, "", Component.literal(""), _level.getServer(), null).withSuppressedOutput(), "summon youtubers_natural_disasters:test_of_sinkhole_entity");
	}
}
