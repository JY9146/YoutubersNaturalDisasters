...
public class WinsweepRenderer extends HumanoidMobRenderer<WinsweepEntity, HumanoidModel<WinsweepEntity>> {
	public WinsweepRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<WinsweepEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0f);
