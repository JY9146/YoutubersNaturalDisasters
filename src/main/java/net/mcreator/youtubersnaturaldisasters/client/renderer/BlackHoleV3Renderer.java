...
public class BlackHoleV3Renderer extends HumanoidMobRenderer<BlackHoleV3Entity, HumanoidModel<BlackHoleV3Entity>> {
	public BlackHoleV3Renderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<BlackHoleV3Entity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
