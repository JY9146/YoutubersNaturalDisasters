...
public class Modeltechnoblade_model<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("youtubers_natural_disasters", "modeltechnoblade_model"), "main");
	...
	public Modeltechnoblade_model(ModelPart root) {
