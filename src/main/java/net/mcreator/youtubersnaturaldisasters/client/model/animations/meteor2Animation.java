...
public class meteor2Animation {
	public static final AnimationDefinition animation = AnimationDefinition.Builder.withLength(1.0F).looping()
			...
			.addAnimation("bone", new AnimationChannel(AnimationChannel.Targets.POSITION, new Keyframe(0.0F, KeyframeAnimations.posVec(37.0F, 33.0F, 80.0F), AnimationChannel.Interpolations.LINEAR))).build();
}
