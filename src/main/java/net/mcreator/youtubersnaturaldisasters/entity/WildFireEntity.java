...
import net.mcreator.youtubersnaturaldisasters.procedures.WildFireOnEntityTickUpdateProcedure;
...
public class WildFireEntity extends Monster {
	public WildFireEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(YoutubersNaturalDisastersModEntities.WILD_FIRE.get(), world);
	}
