...
public class TapLEntity extends Monster {
	public TapLEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(YoutubersNaturalDisastersModEntities.TAP_L.get(), world);
	}

	public TapLEntity(EntityType<TapLEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
