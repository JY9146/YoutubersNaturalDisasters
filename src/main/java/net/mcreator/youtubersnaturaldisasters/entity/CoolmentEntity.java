...
public class CoolmentEntity extends Monster {
	public CoolmentEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(YoutubersNaturalDisastersModEntities.COOLMENT.get(), world);
	}

	public CoolmentEntity(EntityType<CoolmentEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
