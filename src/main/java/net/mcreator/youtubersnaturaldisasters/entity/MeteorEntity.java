...
import net.mcreator.youtubersnaturaldisasters.procedures.MeteorLandsProcedure;
...
public class MeteorEntity extends Monster {
	...
	public MeteorEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(YoutubersNaturalDisastersModEntities.METEOR.get(), world);
	}
	...
	public void baseTick() {
		super.baseTick();
		MeteorLandsProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
