...
public class VolcanoLavaV2Entity extends Monster {
	public VolcanoLavaV2Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(YoutubersNaturalDisastersModEntities.VOLCANO_LAVA_V_2.get(), world);
	}

	public VolcanoLavaV2Entity(EntityType<VolcanoLavaV2Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 100000;
		setNoAi(true);
	...
	public void baseTick() {
		super.baseTick();
		VolcanoLavaV2OnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
