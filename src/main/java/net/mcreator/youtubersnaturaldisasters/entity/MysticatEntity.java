...
public class MysticatEntity extends Monster {
	public MysticatEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(YoutubersNaturalDisastersModEntities.MYSTICAT.get(), world);
	}

	public MysticatEntity(EntityType<MysticatEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
