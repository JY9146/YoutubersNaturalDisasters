...
public class MadPiglinEntity extends Monster {
	public MadPiglinEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(YoutubersNaturalDisastersModEntities.MAD_PIGLIN.get(), world);
	}

	public MadPiglinEntity(EntityType<MadPiglinEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 2;
		setNoAi(false);
