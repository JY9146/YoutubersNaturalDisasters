...
import net.mcreator.youtubersnaturaldisasters.procedures.TechnobladeOnInitialEntitySpawnProcedure;
...
public class TechnobladeEntity extends Monster {
	...
	public void die(DamageSource source) {
		super.die(source);
		TechnobladeEntityDiesProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
	...
	public void awardKillScore(Entity entity, int score, DamageSource damageSource) {
		...
		TechnobladeThisEntityKillsAnotherOneProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), entity);
	}
